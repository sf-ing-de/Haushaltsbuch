...
const parseFile = () => {
  ...
  Papa.parse( fileObject.value, {
        ...
        complete: function( results ){
          ...
          console.log('fileContentNew.value begin: ' + fileContentNew.value + ' fileContentNew.value end\r\n');
        },
        beforeFirstChunk: function(chunk) {
          chunk = chunk.split('\n').slice(fileskipFirstNLines.value);
          console.log('chunk begin: ' + chunk + ' chunk end\r\n');
        },
        skipFirstNLines: fileskipFirstNLines.value
      } );
}
